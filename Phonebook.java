    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (num) {
                ...
                case 7:
                    if(AllEvent.empty()){System.out.println("there are no events to print");}
                    else{
                        AllEvent.findFirst();
                        while(AllEvent.retrieve()!=null)
                       System.out.println(AllEvent.retrieve().toString());  // print all events alphabetically
                        AllEvent.findNext();
                    }
